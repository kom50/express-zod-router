...
The project-structure example demonstrates the recommended mid-sized layout: routes hold handlers, services hold application logic, and no controller folder is needed.
